...
class FillPermissionsForVideojuego extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForVideojuego constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.videojuego',
            'admin.videojuego.index',
            'admin.videojuego.create',
            'admin.videojuego.show',
            'admin.videojuego.edit',
            'admin.videojuego.delete',
            'admin.videojuego.bulk-delete',
        ]);
