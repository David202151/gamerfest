...
class FillPermissionsForHorario extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForHorario constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.horario',
            'admin.horario.index',
            'admin.horario.create',
            'admin.horario.show',
            'admin.horario.edit',
            'admin.horario.delete',
            'admin.horario.bulk-delete',
        ]);
